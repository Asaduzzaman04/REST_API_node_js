...
//! rename processCheckOutcome  to processOutcomeCheck 

worker.processOutcomeCheck = (originalCheckData, checkOutCome) => {
...
worker.alertUserToStatusChange = (newCheckData) => {
  ...
  notification.sendTwilioSms(newCheckData.phone, msg, (err) => {
    if (!err) {
